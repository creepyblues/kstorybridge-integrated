...
describe('creator session inactivity state', () => {
  ...
  it('preserves a protected route and broadcasts inactivity expiration', () => {
    ...
    markSessionExpired('/titles/title-1/edit', '?step=3')
  ...
  it('does not restore auth routes and clears activity state on manual logout', () => {
    markSessionExpired('/signin', '')
