...
export const LAST_ACTIVITY_KEY = 'kstorybridge-creator-auth-last-activity'
export const EXPIRY_BROADCAST_KEY = 'kstorybridge-creator-auth-expired-at'
...
const PROTECTED_PATH_PREFIXES = [
  '/home', '/titles', '/profile', '/plan', '/billing', '/payment', '/requests',
  '/news', '/learning-center', '/updates', '/tools',
]
