...
import { Card, CardContent, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, Button, Input, Table, TableBody, TableCell, TableHead, TableHeader, TableRow, Textarea } from "@kstorybridge/ui";
...
export default function AdminFeaturedTitles() {
  ...
  const handleRemoveFeatured = async (featuredId: string, titleName: string) => {
    ...
    try {
      ...
      toast({ title: "Error", description: "Failed to remove featured title"});
    }
  };
  ...
  const handleAddFeatured = async () => {
    if (!selectedTitle) {
      toast({ title: "Error", description: "Please select a title"});
      return;
    }
    ...
    try {
      ...
      if (isAlreadyFeatured) {
        toast({ title: "Error", description: "This title is already featured"});
        return;
      }
      ...
      toast({ title: "Error", description: "Failed to add featured title"});
    }
  };
