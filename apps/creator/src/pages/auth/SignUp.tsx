    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-porcelain-blue-50 p-4">
      <Card className="w-full max-w-md shadow-xl border-0">
        <CardHeader className="space-y-1 pb-6">
          <CardTitle className="text-3xl font-bold text-midnight-ink">Creator Sign Up</CardTitle>
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="pen_name" className="text-sm font-medium text-gray-900">
                Pen Name / Studio Name <span className="text-red-500">*</span>
              </Label>
              <Input
                id="pen_name"
                name="pen_name"
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-700 mt-1.5">
                Please select your primary role in content creation
              </p>
            </div>
