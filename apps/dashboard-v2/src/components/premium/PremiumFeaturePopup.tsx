  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="bg-gradient-to-b from-white to-blue-50 border-blue-200 rounded-2xl shadow-2xl max-w-md w-[90vw] relative overflow-hidden"
              ...
              {!requested && !messageSent ? (
                <>
                  <div className="space-y-4">
                    ...
                    {featureName === "Contact Creator" && hasAccess('pro') ? (
                      <div className="space-y-4 text-left">
                        ...
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-8 py-4 text-lg rounded-full font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                      ...
                      <Button
                        ...
                        className="w-full bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-8 py-4 text-lg rounded-full font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden group"
                      >
                        {/* Shine effect */}
