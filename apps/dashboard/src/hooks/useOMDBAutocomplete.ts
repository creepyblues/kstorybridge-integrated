 ...
 * Eliminates code duplication between HeroSection and ShowCompSearch.
 *
 * Features:
...
interface UseOMDBAutocompleteReturn {
...
export function useOMDBAutocomplete(
  ...
  }, [query, enabled, maxResults, minChars, clearSuggestions]);
...
export default useOMDBAutocomplete;
