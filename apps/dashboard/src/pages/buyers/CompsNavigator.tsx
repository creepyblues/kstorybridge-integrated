            ...
            <CardContent className="p-6 md:p-8 space-y-6">
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-hanok-teal hover:bg-hanok-teal/90 text-white h-12 text-base font-semibold disabled:bg-gray-300 disabled:opacity-60"
                >
                  {isLoading ? (
                    <>
                ...
                {(compTitles.length > 0 || refinementText || results.length > 0) && (
                  <Button
                    ...
                    disabled={isLoading}
                    variant="outline"
                    className="border-gray-300 hover:bg-gray-100 text-gray-700 h-12 px-6 font-medium"
                  >
                    Clear
                  </Button>
                )}
