import type { FormatAnalysis, FormatType, MicrodramaSpecificInsights } from '@/services/formatSpotlightService';
import { FORMAT_DISPLAY_NAMES } from '@/services/formatSpotlightService';
