-- Fix database trigger to use user_creators table instead of user_ipowners
-- This migration updates the trigger function to work with the renamed table
-- and improves OAuth profile creation reliability

-- Update the trigger function to use user_creators instead of user_ipowners
...
COMMENT ON FUNCTION public.handle_new_user_routing() IS 'Routes new user creation to appropriate profile tables based on account_type metadata. Updated to use user_creators table.';