...
| `introduction_requested` / `introduction_completed` | Reserved | No | No | One historical legacy contact request exists, but no current authoritative request boundary or any completion state/emission exists (`AR-205`, `AR-211`). |
