...
| 2026-07-13 | Produced the first interim weekly operating report from live GA and authoritative Supabase aggregates, and closed a residual development-referrer filter gap in source. | Complete Pacific windows show 82.5% scanner contamination, clean engagement down 24.3 points, a comparatively engaged six-user dashboard cohort, weak homepage/channel engagement, one buyer-interest outcome, and no new profiles/title supply. Activation/retention and canonical zeroes remain explicitly unreported/pending. Four filter tests prove the additional non-production-referrer exclusion. | Release Wave 1, obtain founder/Brevo inputs, then repeat after a complete clean window; do not deploy the filter extension or interpret canonical zeros before the approved release. |
