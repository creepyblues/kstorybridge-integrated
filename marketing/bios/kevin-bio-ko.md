...
Sungho bio is a separate file (TBD); this page can link to it from the closing once ready.
...
**Visual:** portrait + warm dark gradient. Slight desaturation. No text crossing the face area.

---

## Section 2. Lead paragraph

Kevin Nicklaus는 할리우드에서 오랜 시간 원작 기반 IP를 영상으로 옮겨온 producer입니다. Warner Bros. 산하 The Wolper Organization에서 Director of Development부터 Senior Vice President of Development까지 한 회사에서 깊이 경력을 쌓았고, 이후 Tapas Media와 RIDI / Manta에서 한국 플랫폼 IP의 글로벌 진출을 자문해왔습니다. 현재 그가 Executive Producer로 있는 《The Beginning After The End》는 Tapas의 대표 웹툰이 Crunchyroll과 Fuji TV에서 글로벌 anime로 방영 중인 케이스입니다.

---

## Section 3. 신뢰

**Section header:** 한국 창작자의 입장은, 그에게 새로운 주제가 아닙니다
...
**Section header:** 그의 작품들은 지금도 화면 위에서 움직이고 있습니다

Kevin이 현재 동시 진행하고 있는 일들:

- **《The Beginning After The End》 Executive Producer**  
  Tapas 웹툰 → Crunchyroll / Fuji TV 글로벌 애니메이션. 시즌 2가 현재 방영 중입니다.
...
**Visual:** TBATE key visual (small card adjacent to first bullet)

---

## Section 6. Closing

> Kevin은 작가들의 스토리를 평생 영상으로 옮겨온 사람입니다.  
> 이제 그의 다음 작품을 한국 작가들에게서 찾고 있습니다.

*Sungho bio 페이지 준비되면 이 자리에 link 추가*

---

## Section 7. Final CTA

**Section header:** 당신의 작품과 그 무한한 가능성, KStoryBridge와 함께 이야기 나눠보세요

작품에 대한 대화부터 시작합니다.  

▶ **미팅 신청하기** → partners@kstorybridge.com
...
### Sticky mini-nav (선택)
- 우상단 작게: Kevin · 미팅 신청
- Sungho 페이지 합류 시 항목 추가

### 모바일
- Hero 스택 (이름 위 / 사진 아래)
- 단일 컬럼
- 하단 sticky 미팅 신청 버튼 (always within reach)
...
### 사진
- Kevin portrait → `marketing/bios/assets/kevin-portrait.jpg` *(파일 저장 필요)*
- Sungho portrait → `marketing/bios/assets/sungho-portrait.jpg` *(Sungho bio에서 사용)*

### 로고 (사용 권한 확인됨)
- Section 3 footer: Tapas (Kakao) · RIDI · Manta
- Section 4 footer: Warner Bros. · Amazon · Netflix · FX · New Line · History
- Section 5 references: Crunchyroll · Fuji TV · Sandstone Artists · Fangoria Studios · Crazy Maple Studio (ReelShort)

### Proof links
- TBATE Crunchyroll announcement: https://www.crunchyroll.com/news/announcements/2024/10/19/the-beginning-after-the-end-anime-crunchyroll-2025
- Junji Ito *Bloodsucking Darkness* (Variety): https://variety.com/2023/film/news/junji-ito-bloodsucking-darkness-live-action-film-1235568124/
- Kevin LinkedIn: https://www.linkedin.com/in/kevin-nicklaus/
- Kevin IMDb: https://www.imdb.com/name/nm2102454/
- Sandstone Artists Team: https://sandstoneartists.com/team/
...
## Open fact-check items (need Kevin's confirmation, 2026-04-26)
