-- SQL Query to Update Title Keywords
-- Generated from query.xlsx
-- Total Updates: 127 titles
--
-- INSTRUCTIONS:
-- 1. Copy this entire file
-- 2. Go to Supabase Dashboard: https://supabase.com/dashboard/project/dlrnrgcoguxlkkcitlpd/sql/new
-- 3. Paste the SQL
-- 4. Click "Run" to execute
--
-- This will replace existing keywords with new tags from your spreadsheet
...
-- Summary
-- ========================================
-- Total titles updated: 127
-- All existing keywords will be REPLACED with new tags
-- Updated timestamp will be set to current time
